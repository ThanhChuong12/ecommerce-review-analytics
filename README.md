...
| Contributor | Student ID | Role | Key Responsibilities & Contributions | Contribution |
| :--- | :---: | :--- | :--- | :---: |
| **Lê Hà Thanh Chương** | `23120195` | **Team Leader & Core AI Architect** | • **Project Leadership & Architecture:** Oversee project roadmap, design end-to-end microservice architecture and data flow.<br>• **NLP Pipelines & Feature Extraction:** Construct text preprocessing pipeline, TF-IDF, and dense vector embedding extraction.<br>• **ML Model Engineering:** Design, tune, and evaluate Text Baseline Ensemble (Weighted Soft-Voting), fine-tune PhoBERT, and configure Sentiment Zero-shot classifier.<br>• **Multimodal Fusion & Reranking:** Formulate cross-modal fusion engine logic and design Zero-Shot Content-Based Product Reranker.<br>• **EDA & Error Diagnostics:** Perform deep text EDA, visualization, learning curve extraction, and model error analysis. | **100%** |
| **Trà Văn Sỹ** | `23120197` | **Full-Stack & Cloud Deployment Engineer** | • **Full-Stack Platform Deployment:** Build and deploy full-stack web platform (Next.js 16 App Router UI, Express REST API, Supabase) and serve AI Engine endpoints to Cloud.<br>• **UI & Analytics Dashboard:** Implement interactive frontend dashboard displaying Trust Score, multimodal alerts, aspect charts, and PDF exports.<br>• **Vision Auto-Labeling Pipeline:** Build automated image dataset labeling system using Gemini Vision API.<br>• **Media Processing & Vision EDA:** Video frame extraction, image pre-processing, and visual dataset exploratory data analysis. | **100%** |
| **Huỳnh Đức Thịnh** | `23120199` | **Scraping Agent & Vision ML Engineer** | • **Intelligent Scraping Agent:** Develop multi-platform scraping agent with dynamic Dispatcher routing for Tiki, Shopee, Lazada, and TGDD.<br>• **Data Pipeline & Packaging:** Process, clean, and package raw e-commerce datasets for model pipelines.<br>• **MobileNetV3 Architecture:** Design transfer learning strategy, custom loss/scheduler config, and train MobileNetV3 4-class defect detector.<br>• **Vision Evaluation & Diagnostics:** Extract performance metrics (F1, Recall) and conduct False Positive/Negative error analysis for MobileNetV3. | **100%** |
| **Bùi Trung Hiếu** | `23120257` | **Spam System & NLP Research Engineer** | • **Spam & Seeding Detection:** Design & train hybrid spam detection system (21-rule heuristic filter & Hybrid Isolation Forest).<br>• **PhoBERT Training Execution:** Execute production training pipeline for PhoBERT model and implement overfitting mitigation strategies.<br>• **NLP Benchmark Framework:** Build standardized evaluation framework, confusion matrix analysis, and benchmarking suite for NLP models.<br>• **Text EDA & Statistical Validation:** Conduct deep text EDA and perform non-parametric statistical hypothesis testing (Mann-Whitney U test). | **100%** |
| **Lê Công Phúc** | `23120330` | **Computer Vision & Technical Writer** | • **ResNet50 Vision Model:** Design architecture, transfer learning config, dynamic image augmentation pipeline (Albumentations), and train ResNet50.<br>• **Vision Benchmarking:** Conduct comparative benchmark experiments and trade-off analysis between ResNet50 and MobileNetV3.<br>• **Feature Space Exploration:** Perform image feature space analysis (PCA, t-SNE) and local feature extraction.<br>• **Agent Configuration & Docs:** Assist in scraping agent configuration, technical report normalization, and LaTeX/Markdown documentation. | **100%** |
