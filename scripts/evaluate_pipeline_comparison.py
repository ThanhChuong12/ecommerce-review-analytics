...
def main():
    ...
    parser.add_argument("--text-head-path", default="artifacts/models/denoiser/text_sentiment_head.pt")
    parser.add_argument("--image-head-path", default="artifacts/models/denoiser/image_defect_head.pt")
